...
if( !class_exists( 'MV_Slider_Post_Type') ){
    class MV_Slider_Post_Type{
        function __construct(){
            ...
            add_filter( 'manager_edit-mv-slider_sortable_columns', array( $this, 'mv_slider_sortable_columns') );
        }
        ...
        public function save_post( $post_id ){
            ...
            if( isset( $_POST['action'] ) && $_POST['action'] == 'editpost' ){
                ...
                if( empty( $new_link_text )){
                    updated_post_meta( $post_id, 'mv_slider_link_text', 'Add some text' );

                }else{
                    updated_post_meta( $post_id, 'mv_slider_link_text', sanitize_text_field( $new_link_text ),  $old_link_text );
                }

                if( empty( $new_link_url )){
                    updated_post_meta( $post_id, 'mv_slider_link_url', '#');
                }else{
                    updated_post_meta( $post_id, 'mv_slider_link_url', esc_url_raw( $new_link_url ),  $old_link_url );
                }
            }
        }
